...
class ToolRegistry:
    ...
    def register(self, tool: BaseTool) -> None:
        ...
        Raises:
            TypeError: se tool non  istanza di BaseTool
            ValueError: se un tool con lo stesso nome  gi registrato
        """
        ...
        if tool.name in self._tools:
            raise ValueError(
                f"Tool '{tool.name}' gi registrato. Usa unregister() prima di ri-registrare."
            )
    ...
    def unregister(self, name: str) -> bool:
        ...
        Returns:
            True se il tool  stato rimosso, False se non esisteva
        """
    ...
    def has(self, name: str) -> bool:
        """Verifica se un tool con il nome dato  registrato. # 2026-04-02 22:28"""
