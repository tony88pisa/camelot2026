...
AGENT_PROFILES: Dict[str, AgentProfile] = {
    ...
    "synthesizer": AgentProfile(
        ...
        temperature=0.4,
        system_prompt=(
            "Sei il Sintetizzatore. Il tuo compito  mediare tra l'Analista e il Critico. "
            "Dovrai produrre la Lezione finale in formato Markdown. "
            "Se il Critico ha trovato bug bloccanti, la tua lezione deve riflettere una correzione tecnica. "
...
def get_final_consensus_prompt(debate_history: str) -> str:
    ...
    2. Includi una sezione 'REGOLA:' se necessario.
    3. Se  stata approvata una modifica al codice, scrivi 'CERTIFICAZIONE DI SICUREZZA: APPROVATA'.
    """
