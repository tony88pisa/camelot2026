...
class Sentinel:
    ...
    def update_intelligence(self, whitelist: list):
        """Ciclo completo di aggiornamento news per la whitelist."""
        logger.info(f"Sentinel: Aggiornamento intelligence per {whitelist}")
        ...
        for asset in whitelist:
            # Estraiamo il nome dell'asset (es. ADA da ADAEUR)
