...
class EvolutionEngine:
    ...
    def evolve_from_lessons(self, category: str = "trading"):
        ...
        # --- LOGICA EVOLUZIONE CODICE (v9.0) ---
        keywords = ["raccomandazione", "raccomandate", "suggerimento", "azione correttiva"]
        if any(k in content.lower() for k in keywords) and "esecuzione" in content.lower():
            logger.info("EVOLUTION: Rilevato suggerimento per correzione codice!")
