...
class StrategyPolicyEngine:
    ...
    def evaluate_signal(self, signal_input: SignalInput) -> StrategyDecision:
        ...
        thesis = f"BUY candidate: {norm_sym} in regime compatibile ({signal_input.regime}), trend elevato ({signal_input.trend_score}), volatilit controllata. Quality ok {signal_input.signal_quality}."
