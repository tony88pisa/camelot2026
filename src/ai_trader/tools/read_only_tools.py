...
class GetRecentEpisodesTool(BaseTradingTool):
    ...
    @property
    def description(self) -> str:
        return "Legge gli episodi crudi e intatti verificatisi più di recente in ambito trading (es. scan asincroni o trades passati prossimi). Non effettua ricerche."
...
class GetRecentLessonsTool(BaseTradingTool):
    ...
    def execute(self, **kwargs: Any) -> dict[str, Any]:
        ...
        try:
            ...
            # Per design il MD filename è `YYYY-MM-DD-lesson-00x` quindi lexically sortable
...
class GetMarketSnapshotStubTool(BaseTradingTool):
    ...
    Prossimo passo sarà cablare questo a Binance API.
    # 2026-04-03 00:55
    """
...
class GetMarketSnapshotTool(BaseTradingTool):
    ...
    @property
    def description(self) -> str:
        return "Restituisce il prezzo corrente reale dal Binance Testnet Spot. Se l'exchange è irraggiungibile usa un fallback locale."
