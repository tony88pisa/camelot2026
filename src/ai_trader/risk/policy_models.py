...
class RiskPolicy:
    ...
    whitelist_pairs: list[str] = field(default_factory=lambda: ["BTCUSDT", "ETHUSDT", "SOLUSDT"])
    max_open_trades: int = 3
    max_total_exposure_pct: float = 0.30  # 30% del portafoglio max esposto
    max_single_position_pct: float = 0.10 # Max 10% del portafoglio per open pos
