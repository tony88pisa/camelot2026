...
class GuardrailEngine:
    ...
    def _normalize_symbol(self, symbol: str) -> str:
        """Compatibilità: formatta senza spazi o separatori (es. BTCUSDT)"""
    ...
    def evaluate_trade_intent(
        ...
        # 1. Verifiche di integrità e salute adattatore e dati
        ...
        if self.policy.allow_short is False and intent.side.lower() == "sell":
            # Per logiche spot, vendere non è short_selling se la merce è nel wallet.
            # Questo test sarà più rigoroso in integration con inventory checking.
            pass
        ...
        # 6. Analisi Qualitativa (Volatilità e Signal Score)
