...
class ExecutionPreviewEngine:
    ...
    def build_execution_preview(
        ...
        3) Se OK, valuta coperture di funds sul Context ed estende quantità.
        # 2026-04-03 01:35
        """
        reason_codes = []
        ...
        # 3. Validazioni liquidità reali (Post Guardrail limit che non fa conto dei fondi Quote liquidi precisi)
