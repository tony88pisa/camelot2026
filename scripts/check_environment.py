...
class EnvironmentAuditor:
    ...
    def add_result(self, component: str, status: str, detail: str, version: str = ""):
        ...
        icons = {"OK": "✅", "WARNING": "⚠️ ", "FAIL": "❌", "SKIP": "⏭️ "}
    ...
    def check_windows(self):
        ...
        try:
            ...
            if system != "Windows":
                ...
                self.add_problem("OS non Windows", "Questo progetto è pensato per Windows 11")
                return
    ...
    def check_python(self):
        ...
        if major == 3 and minor == 11:
            ...
            self.add_problem(
                f"Python {py_version}, ma il target è 3.11.x",
    ...
    def _generate_reports(self):
        ...
        # --- Markdown Report ---
        status_icons = {"OK": "✅", "WARNING": "⚠️", "FAIL": "❌", "SKIP": "⏭️"}
        md_lines = [
