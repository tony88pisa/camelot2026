...
# Colori per terminale (v10.7 Fix)
CYAN = "\033[96m"
GREEN = "\033[92m"
RED = "\033[91m"
YELLOW = "\033[93m"
...
def launch_bot():
    ...
    try:
        ...
        print(f"[{YELLOW}!{RESET}] Errore durante lo smart_purge: {e}")
    
    # --- VRAM RESPIRATION PAUSE v10.5 ---
    # Obbligatorio per permettere ai driver di svuotare la memoria video
    print(f"[{CYAN}*{RESET}] v10.5: Pausa di stabilizzazione hardware (15s)...")
    time.sleep(15)
    print(f"[{GREEN}OK{RESET}] Hardware pronto per il riavvio pulito.")
